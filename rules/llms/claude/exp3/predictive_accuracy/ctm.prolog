...
holdsFor(driving_style(Id, VehicleType)=uncomfortable, I) :-
    ...
    holdsFor(abrupt_deceleration(Id, VehicleType)=very_abrupt, I3),
    union_all([I2, I3], I4),
    relative_complement_all(I1, [I4], I5),
    holdsFor(abrupt_acceleration(Id, VehicleType)=abrupt, I6),
    holdsFor(abrupt_deceleration(Id, VehicleType)=abrupt, I7),
    union_all([I5, I6, I7], I).
