...
holdsFor(driving_style(Id, VehicleType)=uncomfortable, I) :-
    ...
    holdsFor(abrupt_deceleration(Id, VehicleType)=very_abrupt, Ivd1),
    union_all([Iva1, Ivd1], Ivery),
    relative_complement_all(Is, [Ivery], Isharp),
    holdsFor(abrupt_acceleration(Id, VehicleType)=abrupt, Ia1),
    holdsFor(abrupt_deceleration(Id, VehicleType)=abrupt, Id1),
    union_all([Isharp, Ia1, Id1], I).
