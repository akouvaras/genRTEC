...
holdsFor(anchoredOrMoored(Vessel)=true, I) :-
    holdsFor(stopped(Vessel)=nearPorts, Snear),
    holdsFor(stopped(Vessel)=farFromPorts, Sfar),
    holdsFor(withinArea(Vessel, anchorage)=true, Ia),
    intersect_all([Sfar, Ia], Ianchored),
    union_all([Snear, Ianchored], I).
