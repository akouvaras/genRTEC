...
grounding(anchoredOrMoored(Vessel)=true):-
	vessel(Vessel).
grounding(anchored_far(Vessel)=true):-
	vessel(Vessel).
...
grounding(loitering(Vessel)=true):-
	vessel(Vessel).
grounding(loitering_base_state(Vessel)=true):-
	vessel(Vessel).
grounding(pilotOps_candidate(Vessel1, Vessel2)=true):-
	vpair(Vessel1, Vessel2).
grounding(pilotSpeedOrStopped(Vessel)=true):-
	vessel(Vessel).
