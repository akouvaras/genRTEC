...
holdsFor(driving_style(Id, VehicleType)=uncomfortable, I) :-
    ...
    holdsFor(abrupt_acceleration(Id, VehicleType)=very_abrupt, I_very_accel),
    holdsFor(abrupt_deceleration(Id, VehicleType)=very_abrupt, I_very_decel),
    relative_complement_all(I_sharp, [I_very_accel, I_very_decel], I_A),
    holdsFor(abrupt_acceleration(Id, VehicleType)=abrupt, I_abrupt_accel),
    holdsFor(abrupt_deceleration(Id, VehicleType)=abrupt, I_abrupt_decel),
    union_all([I_abrupt_accel, I_abrupt_decel], I_B),
    union_all([I_A, I_B], I).
