...
holdsFor(moving(P1, P2)=true, I) :-
    ...
    holdsFor(close_34(P1,P2)=true, I_close),
...
holdsFor(fighting(P1, P2)=true, I) :-
    holdsAt(person(P1)=true, _),
    holdsAt(person(P2)=true, _),
	holdsFor(close_34(P1,P2)=true, I_close),
    holdsFor(abrupt(P1)=true, I_ab1),
    holdsFor(inactive(P2)=true, I_inact2),
    relative_complement_all(I_ab1, [I_inact2], I_case1),
    intersect_all([I_case1, I_close], I1_final),
    holdsFor(abrupt(P2)=true, I_ab2),
    holdsFor(inactive(P1)=true, I_inact1),
