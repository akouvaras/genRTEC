...
holdsFor(driving_style(Id, VehicleType)=uncomfortable, I) :-
    holdsFor(sharp_turn(Id, VehicleType)=sharp, Ia),
    holdsFor(abrupt_acceleration(Id, VehicleType)=very_abrupt, Iaa),
    holdsFor(abrupt_deceleration(Id, VehicleType)=very_abrupt, Iad),
    union_all([Iaa, Iad], I_very_abrupt),
    relative_complement_all(Ia, [I_very_abrupt], I_case1),
    holdsFor(abrupt_acceleration(Id, VehicleType)=abrupt, Ib1),
    holdsFor(abrupt_deceleration(Id, VehicleType)=abrupt, Ib2),
    union_all([Ib1, Ib2], I_case2),
    union_all([I_case1, I_case2], I_result),
    I_result \= [],
    I = I_result.
...
holdsFor(driving_quality(Id, VehicleType)=high, I) :-
    ...
    union_all([Iu, Iuc], I_bad_style),
    relative_complement_all(Ip, [I_bad_style], I_high),
    I_high \= [],
    I = I_high.
